      ...
      <div className="py-8 md:py-24 md:pb-0">
        <Layout>
          <div className="grid lg:grid-cols-2 gap-8 ">
            ...
            <div>
              <div className="bg-white feshadow p-4 md:p-12 rounded-lg xl:w-8/12 mx-auto relative margin z-10">
                    ...
                    <div class="space-y-3">
                      ...
                      <div>
                        ...
                        {!isOtpSent && (
                          <button
                            ...
                            className="form-control bg-black text-white mt-2 py-1 rounded-lg"
                      ...
                      {isOtpSent && (
                        <div>
                          ...
                          <button
                            ...
                            disabled={isOtpVerified}
                          >
                            {isOtpVerified ? "Verified OTP ✔" : "Verify OTP"}
                          </button>
                        </div>
                      )}
                      <div>
                      ...
                      <div>
                        <div class="flex items-start">
                          <input
                            type="checkbox"
                            class="shrink-0 mt-0.5 border-gray-200 rounded text-black focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                      ...
                      <div className="text-center">
                        <button
                          type="submit"
                          className="form-control bg-black text-white mb-6 py-2 px-12 rounded-lg text-xl font-semibold"
